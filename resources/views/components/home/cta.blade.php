                ...
                <div class="flex flex-col items-center gap-4 sm:flex-row sm:justify-center">
                    @auth
                        <a href="{{ route('dashboard') }}"
                           class="inline-flex cursor-pointer items-center gap-2 rounded-md bg-primary-foreground px-8 py-3 text-sm font-semibold text-primary transition-opacity hover:opacity-90">
                            Go to dashboard
                    ...
                    @else
                        ...
                        <a href="{{ route('login') }}"
                           class="inline-flex items-center gap-2 text-sm text-primary-foreground/80 underline underline-offset-4 hover:text-primary-foreground">
