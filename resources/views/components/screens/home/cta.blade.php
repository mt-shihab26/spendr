<section class="py-24">
    <div class="mx-auto max-w-7xl px-4">
        <div class="bg-primary relative overflow-hidden px-8 py-16 text-center">
            {{-- Background pattern --}}
            ...
            <div class="relative">
                <h2 class="text-primary-foreground mb-4 text-3xl font-bold tracking-tight lg:text-4xl">
                    Take control of your money today
                </h2>
                <p class="text-primary-foreground/80 mx-auto mb-8 max-w-lg">
                ...
                <div class="flex flex-col items-center gap-4 sm:flex-row sm:justify-center">
                    ...
                    @else
                        ...
                        <x-ui.button
                            variant="ghost"
                            class="text-primary-foreground/80 hover:text-primary-foreground hover:bg-white/10"
                            href="{{ route('login') }}"
                        >
