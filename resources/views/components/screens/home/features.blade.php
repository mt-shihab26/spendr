...
$features = [
    ...
    [
        ...
        'desc'  => 'Set up subscriptions and regular payments once. ' . config('app.name') . ' auto-logs them so your records stay accurate without manual entry.',
    ],
    [
        'icon'  => 'chart-pie',
...
<section id="features" class="py-10 lg:py-16">
