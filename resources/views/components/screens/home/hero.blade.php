        ...
        >
            ...
            <div class="grid grid-cols-3 gap-4 p-6 lg:grid-cols-4">
                ...
                <div class="col-span-3 grid grid-cols-3 gap-4 lg:col-span-4">
                    @foreach ([
                        ...
                        <div class="border border-border bg-background p-4">
                            ...
                            <p
                                class="text-xl font-bold {{ $stat['color'] }}"
                            >{{ $stat['value'] }}</p>
                ...
                <div class="col-span-3 border border-border bg-background p-4">
                    <p class="mb-3 text-xs font-medium tracking-wide text-muted-foreground uppercase">Recent transactions</p>
                    <div class="space-y-3">
                        @foreach ([
                            ...
                            <div class="flex items-center justify-between">
                                ...
                                <span
                                    class="text-sm font-mono font-medium {{ $tx['color'] }}"
                                    >{{ $tx['amount'] }}</span
                                >
                            </div>
                        @endforeach
                ...
                {{-- Budget progress --}}
                <div
                    class="hidden border border-border bg-background p-4 lg:block"
                >
                    <p class="mb-3 text-xs font-medium tracking-wide text-muted-foreground uppercase">Budget</p>
                    <div class="space-y-3">
                        @foreach ([
                            ['label' => 'Food', 'pct' => 72],
                            ...
                            <div>
                                ...
                                <div
                                    class="h-1.5 w-full rounded-full bg-accent"
                                >
                                    <div
