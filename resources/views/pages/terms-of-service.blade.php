...
>
    <x-screens.legal.paragraph>
        Please read these Terms of Service carefully before using {{ config('app.name') }}.
    ...
    <x-screens.legal.section heading="1. Acceptance of Terms">
        <x-screens.legal.paragraph>
            ...
            agreement between you and {{ config('app.name') }} ("we", "us", or
            "our"). By creating an account or using any part of the service, you
    ...
    <x-screens.legal.section heading="2. Use of Service">
        <x-screens.legal.paragraph class="mb-4">
            {{ config('app.name') }} provides personal finance tracking tools
            for individual, non-commercial use. You agree to use the service
            only for lawful purposes and in accordance with these Terms. You
            must not:
        </x-screens.legal.paragraph>
        <x-screens.legal.list>
            <li>
                Use the service to store, transmit, or process any illegal
                financial activity
            </li>
            <li>
            ...
            <li>
                Impersonate any person or entity or misrepresonate your
                affiliation
            </li>
        </x-screens.legal.list>
    </x-screens.legal.section>
    ...
    <x-screens.legal.section heading="5. Your Data">
        <x-screens.legal.paragraph>
            You retain ownership of all financial data you enter into {{ config('app.name') }}.
            By using the service, you grant us a limited licence to store,
            process, and display your data solely for the purpose of operating
            the service. We do not claim ownership of your data and will never
            sell it to third parties. You may export or delete your data at any
            time.
        </x-screens.legal.paragraph>
    </x-screens.legal.section>
    ...
    <x-screens.legal.section heading="6. Intellectual Property">
        <x-screens.legal.paragraph>
            The {{ config('app.name') }} name, logo, software, design, and all
            related content are the exclusive property of {{ config('app.name') }} and
    ...
    <x-screens.legal.section heading="7. Disclaimer of Warranties">
        <x-screens.legal.paragraph>
            {{ config('app.name') }} is provided "as is" without warranties of
            any kind, express or implied. We do not warrant that the service
            will be uninterrupted, error-free, or completely secure. {{ config('app.name') }} is
            a budgeting tool and does not provide financial, investment, tax, or
            legal advice.
        </x-screens.legal.paragraph>
    </x-screens.legal.section>
    ...
    <x-screens.legal.section heading="8. Limitation of Liability">
        <x-screens.legal.paragraph>
            To the maximum extent permitted by law, {{ config('app.name') }} shall
            ...
            damages. Our total liability to you shall not exceed the amounts
    ...
    <x-screens.legal.section heading="9. Termination">
        <x-screens.legal.paragraph>
            ...
            cancel your subscription and delete your account from your settings.
            We reserve the right to suspend or terminate your access for
            violation of these Terms, with or without notice. Upon termination,
    ...
    <x-screens.legal.section heading="10. Governing Law">
        <x-screens.legal.paragraph>
            ...
            applicable laws. Any dispute arising under these Terms shall be
    ...
    <x-screens.legal.section heading="11. Changes to Terms">
        <x-screens.legal.paragraph>
            ...
            Your continued use after the effective date of changes constitutes
    ...
    <x-screens.legal.section heading="12. Contact Us">
        <x-screens.legal.paragraph>
            ...
            <a
                href="mailto:{{ 'legal@' . parse_url(config('app.url'), PHP_URL_HOST) }}"
                class="text-primary underline underline-offset-4 hover:opacity-80"
                >{{ 'legal@' . parse_url(config('app.url'), PHP_URL_HOST) }}</a
            >.
        </x-screens.legal.paragraph>
    </x-screens.legal.section>
</x-layouts.legal>
