...
>
    ...
    <x-screens.legal.section heading="3. Refund Eligibility">
        <div class="space-y-4 leading-relaxed text-muted-foreground">
            <x-screens.legal.paragraph>We offer refunds in the following circumstances:</x-screens.legal.paragraph>
            ...
            <x-screens.legal.paragraph>Refunds are not available for partial months, plan downgrades, or unused portions of a subscription period outside of the 30-day window.</x-screens.legal.paragraph>
        </div>
    </x-screens.legal.section>
